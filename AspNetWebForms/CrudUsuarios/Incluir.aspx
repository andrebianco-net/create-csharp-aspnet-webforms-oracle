<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Incluir.aspx.cs" Inherits="CrudUsuarios.Incluir" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <div id="divPopUp1" class="pnlBackGround">
            ...
            <hr />
            <div id="main" class="mainPnlBackGround">Inclusão realizada com sucesso!</div><br />
            <hr />
            <div id="buttons" class="btnIncluir">
                <div id="DivBtnIncluirOk" class="btnIncluirOk"><asp:Button id="btnIncluirOk" CssClass="btn btn-primary" runat="server" text="Ok" OnClick="btnIncluirOk_Click"/></div>
            </div>                
        </div>
    </div>
